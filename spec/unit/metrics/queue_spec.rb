    ...
    describe Queue do
      ...
      describe '#counters' do
        it 'should return currently queued counters' do
          subject.add transactions: { type: :counter, value: 12_345 },
                      register_cents: { type: :gauge, value: 211_101 }
          subject.counters.should eql [{ name: 'transactions', value: 12_345, measure_time: @time }]
        end
      ...
      describe '#empty?' do
        ...
        it 'should return false with queued items' do
          subject.add foo: { type: :gauge, value: 121_212 }
      ...
      describe '#gauges' do
        it 'should return currently queued gauges' do
          subject.add transactions: { type: :counter, value: 12_345 },
                      register_cents: { type: :gauge, value: 211_101 }
          subject.gauges.should eql [{ name: 'register_cents', value: 211_101, measure_time: @time }]
        end
        ...
        context 'with another queue' do
          ...
          it 'should track previous default source' do
            ...
            q2.queued[:gauges].each do |gauge|
              gauge[:source].should == 'matrix' if gauge[:name] == 'neo'
            end
          end
        ...
        context 'with an aggregator' do
          it 'should merge' do
            ...
            expected = { gauges: [{ name: 'gauge', value: 42, measure_time: @time },
                                  { name: 'timing', count: 2, sum: 305.0, min: 102.0, max: 203.0,
                                    source: 'aggregator' }],
                         source: 'queue' }
